...
- **Komerčný SaaS produkt** — predajom služby by sa z advokáta stal poskytovateľ softvéru ([ADR 0002](../decisions/0002-preco-forkujeme-mikeoss.md))
- **Náhrada právneho úsudku advokáta** — zodpovednosť za výstup nesie vždy advokát (Metodické usmernenie SAK 2025)
- Uzavretý ekosystém alebo vendor lock-in

## Monetizácia

Výhradne **workshopy a školenia** — ako s nástrojom efektívne pracovať. Softvér ostáva zadarmo a otvorený.
