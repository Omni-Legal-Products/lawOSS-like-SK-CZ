...
| 36 | **Hranica vynútená v nástroji, nie v prompte** — *„čo agent nesmie, mu nemá ísť ponúknuť"*; povinný `--dry-run` pri odosielaní a odstránenie rizikových funkcií z nástrojovej plochy (u VŘ zúženie zo 79 nástrojov na 12, vypnutý webhook zneužiteľný cez prompt injection) | **VŘ** | 2026-08-15 | 💭 **nápad** · **navrhnuté do [ADR 0007](https://github.com/Omni-Legal-Products/lawOSS-like-SK-CZ/pull/19)**, ten čaká na MF | [odpovede VŘ, Q21](../planning/2026-08-15-odpovedi-VR-Q01-Q25.md) |
