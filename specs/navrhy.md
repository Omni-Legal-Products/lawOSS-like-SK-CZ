...
| 19 | **Natívna autorizácia PDF a XML podľa eIDAS** — QES + QTS cez [Autogram](https://github.com/slovensko-digital/autogram); MČ ho už používa cez CLI ako Finder quick action a robí naň natívny macOS fork | **MČ** | 2026-08-06 | 💭 nápad · dizajnový prieskum · ⚠️ **Autogram je EUPL-1.2** → volať ako externý proces, nevendorovať | [spracovanie topicu](../research/idey/2026-08-07-feature-ideas-telegram.md) |
