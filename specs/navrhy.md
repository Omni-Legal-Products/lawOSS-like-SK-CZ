...
| 28 | **Reconcile — učenie z úprav advokáta** — porovnanie AI draftu s finálom, najmenšia zmena inštrukcií; rebrík umiestnenia nad OKF (spis → kancelária → komunita) s anonymizačnou bránou (nadväzuje na #27). Inšpirácia: skill Jeffa Su (koncept, nie text — platený kurz bez licencie) | **MČ** | 2026-08-11 | 📝 návrh · V2 kandidát — konkretizuje #21 | [spec 0009](0009-reconcile-ucenie-z-uprav.md) |
