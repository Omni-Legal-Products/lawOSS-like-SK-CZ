...
| 52 | **OKF 1.0 ako otvorený kontrakt klienta a prípadov** - `AGENTS.md` ako kanonický vstup, klientsky workspace s viacerými prípadmi, typované records, `Truth` + `History`, Basic verification, reconciliation a jeden portable core pre CLI, agentov aj LAWOSS | **MČ** *(konsoliduje prínosy VŘ)* | 2026-08-31 | 📝 **spec** · návrh na spoločnú revíziu, nie je odklepnuté VŘ ani tímom | [spec 0014](0014-okf-1-kanonicky-kontrakt.md) · [porovnanie](../research/okf-implementacie/porovnanie-a-konsolidacia-2026-08-31.md) · [vizualizácia](../assets/diagrams/okf-konsolidacia.html) |
| 53 | **Osobné LAWOSS dashboardy nad OKF** - šesť vizuálne a UX odlišných presetov tej istej natívnej obrazovky `/prehlad`; osobný layout zobrazuje jeden typovaný read model a nikdy neukladá právne fakty | **MČ** | 2026-09-01 | 📝 **spec** · návrh na spoločnú revíziu, nie je odklepnuté tímom | [spec 0015](0015-lawoss-okf-osobne-dashboardy.md) · [varianty 1 až 3](../docs/design/hifi/lawoss-okf-personal-dashboard-presets-1-3.html) · [varianty 4 až 6](../docs/design/hifi/lawoss-okf-personal-dashboard-presets-4-6.html) |
