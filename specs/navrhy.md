...
| 51 | **Session log — pracovný denník spisu** — append-only `CHANGELOG.md` v OKF entite; agent na konci sedenia zapíše čo sa dialo, čo sa zmenilo a čo zostalo otvorené. Vymedzený voči `_STATUS.md` § Chronológia (práca × udalosti veci). Kondenzácia vedome odložená — namiesto nej pravidlo „čítaj posledných 5" | **MČ** | 2026-08-21 | 📝 **spec** · zatvára **Q13** a auditovateľnosť z #37 (VŘ) | [spec 0012](0012-session-log.md) · [rešerš Granular](../research/inspiracie/2026-08-21-granular-brain-a-pamatove-vzory.md) |
