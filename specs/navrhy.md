...
| 19 | **Natívna autorizácia PDF a XML podľa eIDAS** — QES + QTS, advokátske preukazy, české elektronické podpisy, dôveryhodná služba vytvárania podpisov, časová pečiatka | **MČ** | 2026-08-06 | 💭 nápad · **v štádiu dizajnového prieskumu** — MČ nadhodil v Telegram topicu *DESIGN* a nechal zapracovať do mockupov; zatiaľ nerozpracované | [keyvisualy](../assets/brand/) |
