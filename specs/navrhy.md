...
| 27 | **Lokálny anonymizačný gate pred externým LLM** — lokálna detekcia, nezávislé overenie a povinné potvrdenie pred externým routingom | **MF** | 2026-08-11 | 📝 návrh · architektonický P0 / implementácia V1.1/P1 | [spec 0008](0008-anonymizacia-a-privacy-gate.md) · [Issue #15](https://github.com/originalmagneto/lawOSS-like-SK-CZ/issues/15) |
