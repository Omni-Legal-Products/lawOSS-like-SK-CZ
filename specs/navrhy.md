...
| 49 | **LAWOSS UI vrstva** — settings tab „LAWOSS" (meno advokáta, nomenklatúra, autonómia, výstupný formát), agent-driven spis wizard cez command palette, timeline fáza 1 ako HTML artifact / fáza 2 panel tab; modularita OKF cez `lawoss.config.md` | **MČ** | 2026-08-21 | 📝 **spec** · UI body overené v kóde upstreamu 2026-08-21 | [spec 0011](0011-rozsirujuca-vrstva-ui-a-konektory.md) |
| 50 | **Connector registry** — tri vrstvy MCP: povinné jadro (feature závislosti s graceful fallback) / katalóg local+remote / vlastné servery používateľa (BYO); prepojenie skill↔MCP cez schopnosti, pin + canary + rollback; samostatné repo mimo forku | **MČ** | 2026-08-21 | 📝 **spec** · rozvíja #45 a ADR 0008 | [spec 0011](0011-rozsirujuca-vrstva-ui-a-konektory.md) |
