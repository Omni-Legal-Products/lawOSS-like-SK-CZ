...
| 52 | **OKF CLI, Fáza A a profily vecí** — čo je `okf` CLI a prečo drží prenositeľnosť; najprv Fáza A bez zásahu do servera; typ a režim veci (spor · korporát · IP · registrácie · insolvencie) ako profily v `okf.yaml`, nie nové systémy | **MČ** | 2026-09-02 | 📝 **spec** · nadväzuje na 0002 a konsolidáciu 1. 9. | [spec 0013](0013-okf-cli-a-profily-veci.md) |
