...
| 0012 | [Jeden MCP endpoint pre viacero právnych zdrojov](0012-jeden-mcp-endpoint-pre-viacero-pravnych-zdrojov.md) | MČ | návrh | V1/V2 | doménová fasáda nad routingom, verifikáciou a oficiálnymi konektormi |
