...
| 0013 | [OKF CLI, Fáza A v LAWOSS a profily vecí](0013-okf-cli-a-profily-veci.md) | MČ | [PR #67](https://github.com/Omni-Legal-Products/lawOSS-like-SK-CZ/pull/67) — **otvorený** | jadro OKF | čo je `okf` CLI · Fáza A pred B · `matter.type` + `matter.mode` ako profily · termín namiesto lehoty |
...
- [ ] Zmergovať [PR #2](https://github.com/Omni-Legal-Products/lawOSS-like-SK-CZ/pull/2) a uvoľniť tým číslo 0006
